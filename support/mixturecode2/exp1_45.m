...
for delta=1.8:0.1:2.6
  ...
  common_file_prefix = strcat('./exp1_45/data/delta_',delta_str,'/mvnorm_iter_');
  summary_file = strcat('./exp1_45/summary/delta_',delta_str);
  summary = fopen(summary_file,'w');
  params_file = strcat('./exp1_45/summary/delta_',delta_str,'_parameters');
  parameters = fopen(params_file,'w');
  data_folder = strcat('./exp1_45/data/delta_',delta_str);
  success_rate = 0;
  inferred = []
...
%    sample = y';
    ...
    mix_file = strcat('./exp1_45/mixtures/delta_',delta_str,'/mvnorm_iter_',iter_str);
